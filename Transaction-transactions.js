...
runTransaction().then((transactionResponse) => {
    ...
    //write the first id into translist.json for later using by other transaction APIs.
    let jsondata = { amount: transactionResponse.rows[ 0 ].amount, id: transactionResponse.rows[ 0 ].id };
